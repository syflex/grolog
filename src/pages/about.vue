<template>
  <q-page>
    <!-- content -->
    <!-- <div class="fixed-top">
      <q-parallax src="statics/img/parallax-2.jpg" :height="150">
          <q-breadcrumbs>
            <q-breadcrumbs-el label="Home" />
            <q-breadcrumbs-el class="text-white" label="About Us" />
          </q-breadcrumbs>
      </q-parallax>
    </div> -->
    ...
    <div class="q-pa-lg">
     <div class="text-h3">About Us</div>
      <div class="q-my-sm" style="width:250px">
        <q-separator color="primary"/>
        <q-separator color="primary"/>
      </div>

      <p>
        Agrolog Limited (RC 1527119) is a newly established agribusiness company specialized in production and
        trade of agricultural commodities, agrologistics, various agricultural investment and farm management.
        Innovations that assure the delivery of wholesome food to consumers constitute the value proposition
        which AgroLog brings to its clients. Institutional voids constitute great impediments in food systems,
